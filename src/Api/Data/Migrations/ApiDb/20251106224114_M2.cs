        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CRA = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SalesReceiptLine_Item_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Item",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SalesReceiptLine_Measurement_MeasurementId",
                        column: x => x.MeasurementId,
                        principalTable: "Measurement",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Company",
                columns: new[] { "Id", "CRA", "CompanyCode", "Name", "ShortName" },
                values: new object[] { 1, "012345678", "100", "Financial Solutions Inc.", "FSI" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesReceiptLine_ItemId",
                table: "SalesReceiptLine",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesReceiptLine_MeasurementId",
                table: "SalesReceiptLine",
                column: "MeasurementId");
